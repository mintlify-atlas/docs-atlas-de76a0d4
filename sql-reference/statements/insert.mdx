...
- [SELECT](/sql-reference/statements/select) — query syntax used with `INSERT INTO ... SELECT`
- [UPDATE](/sql-reference/statements/update) — modify existing rows
- [DELETE](/sql-reference/statements/delete) — remove rows
- [CREATE TABLE](/sql-reference/statements/create-table) — column definitions and default values
